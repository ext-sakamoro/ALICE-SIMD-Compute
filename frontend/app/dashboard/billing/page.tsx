...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['1,000 ops/hr', 'Vectors up to 1K dims', 'f32 precision only', 'Community support'] },
  { name: 'Pro', price: '$39/mo', features: ['100K ops/hr', 'Unlimited dimensions', 'f32 + f64 precision', 'Matrix operations', 'Priority support'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited operations', 'GPU offload', 'Dedicated compute', 'SLA guarantee', 'Dedicated support'] },
];
